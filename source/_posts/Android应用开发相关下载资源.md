...
#### (5)platforms (各种版本的Android平台，释放到android-sdk-windows/platforms下)
Android 1.1 (API 2):
...
#### (6)system-images (Android系统镜像，释放到android-sdk-windows/system-images/android-xx下[xx对应api版本数字])
...
#### (7)docs (文档，释放到android-sdk-windows下，会产生文件夹docs)
